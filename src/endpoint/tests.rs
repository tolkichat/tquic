...
impl TestPair {
    ...
    fn run(&mut self, cli_conf: Config, srv_conf: Config, case_conf: CaseConf) -> Result<()> {
        self.run_with_packet_filter(cli_conf, srv_conf, case_conf, Box::new(NoopPacketFilter {}))
    }
    ...
    fn run_with_packet_filter(
        ...
        let srv_sock = TestSocket::new(srv_poll.registry(), &case_conf, "SERVER".into()).unwrap();
...
const TEST_INITIAL: [u8; 700] = [
    ...
    0x25, 0x2d, 0x62, 0x35, 0x36, 0x5e, 0x9b, 0x84, 0x39, 0x2b, 0x06, 0x10,
];

// Test stateless reset packet.
const TEST_STATELESS_RESET: [u8; 42] = [
    0x40, 0xc1, 0xe7, 0x9a, 0xb0, 0x94, 0xc7, 0xa2, 0x49, 0x43, 0x84, 0xbb, 0x23, 0x05, 0x6f, 0x20,
    0x11, 0x0f, 0x9b, 0x13, 0x01, 0x36, 0xf3, 0xa0, 0x45, 0xb8, 0x9f, 0x09, 0x36, 0x79, 0x0f, 0xc2,
    0x7f, 0x14, 0xed, 0x3d, 0x67, 0xbf, 0x79, 0x21, 0xad, 0xc7,
];
